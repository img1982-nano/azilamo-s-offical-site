<h1 class="font-mono font-bold text-black dark:text-white text-6xl flex justify-start mt-4">| About</h1>
<div class="font-mono text-black dark:text-white p-4">
    <p>Hello Im azilamo / img1982-nano</p>
    <p>I from Japan/Miyagi-ken/Sendai-city</p>
    <p>I Like music video game Maimai, Chunithm, Ongeki, SoundVoltex,etc...</p>
    <p>Technology Stack(Learning now): MongoDB, Svelte, JS/TS, Python, Linux(Debian, arch), ProxmoxVE</p>
</div>
