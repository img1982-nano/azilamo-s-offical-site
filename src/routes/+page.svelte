...
<h1 class="font-mono font-bold text-black dark:text-white text-6xl flex justify-center mt-4">Azilamo</h1>
<p class="text-black dark:text-white flex justify-center">weirdo, beginner programmer, Server | age:13 | 🤔</p>
...
<p class="text-black dark:text-white flex justify-end">(im amanens)</p>
